...
import gmoo.com.gmudevelopers.edu.gmoo.data.SearchDataManager;
...
import gmoo.com.gmudevelopers.edu.gmoo.ui.transitions.CircularReveal;
import gmoo.com.gmudevelopers.edu.gmoo.util.ImeUtils;
import gmoo.com.gmudevelopers.edu.gmoo.util.ShortcutHelper;
...
public class SearchActivity extends Activity {
    ...
    @BindView(R.id.save_designer_news)
    CheckedTextView saveDesignerNews;
    @BindView(R.id.scrim)
    View scrim;
