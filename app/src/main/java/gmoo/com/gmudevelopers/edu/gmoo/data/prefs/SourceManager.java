...
package gmoo.com.gmudevelopers.edu.gmoo.data.prefs;
...
public class SourceManager {
    ...
    Source getSource(Context context, String key, boolean active) {
...
/*
    <string name="source_browse">Browse</string>
    <string name="source_sell_your_stuff">Sell Your Stuff</string>
    <string name="source_chat">Chat</string>
    <string name="source_categories">Categories</string>
    <string name="source_my_profile">My profile</string>
    <string name="source_logout">Log out</string>
