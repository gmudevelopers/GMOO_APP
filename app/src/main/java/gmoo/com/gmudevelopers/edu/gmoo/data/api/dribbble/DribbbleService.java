...
package gmoo.com.gmudevelopers.edu.gmoo.data.api.dribbble;
...
public interface DribbbleService {
    ...
    Call<List<gmoo.com.gmudevelopers.edu.gmoo.data.api.dribbble.model.Comment>> getComments(@Path("id") long shotId,
                                    @Query("page") Integer page,
                                    @Query("per_page") Integer pageSize);
    ...
    Call<gmoo.com.gmudevelopers.edu.gmoo.data.api.dribbble.model.Comment> postComment(@Path("shot") long shotId,
    ...
    @GET("v1/users/{user}")
    Call<gmoo.com.gmudevelopers.edu.gmoo.data.api.dribbble.model.User> getUser(@Path("user") long userId);

    @GET("v1/users/{user}")
    Call<gmoo.com.gmudevelopers.edu.gmoo.data.api.dribbble.model.User> getUser(@Path("user") String username);

    @GET("v1/user")
    Call<gmoo.com.gmudevelopers.edu.gmoo.data.api.dribbble.model.User> getAuthenticatedUser();
