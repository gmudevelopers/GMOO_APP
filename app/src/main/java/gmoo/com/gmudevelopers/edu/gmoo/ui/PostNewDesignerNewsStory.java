...
import gmoo.com.gmudevelopers.edu.gmoo.ui.widget.ObservableScrollView;
...
public class PostNewDesignerNewsStory extends Activity {
    ...
    @BindView(R.id.new_story_url)
    EditText url;
    @BindView(R.id.new_story_comment_label) TextInputLayout commentLabel;
    @BindView(R.id.new_story_comment)
    EditText comment;
    @BindView(R.id.new_story_post)
    Button post;
